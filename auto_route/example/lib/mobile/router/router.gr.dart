...
class RootRouter extends _i4.RootStackRouter {
  ...
  final Map<String, _i4.PageFactory> pagesMap = {
    ...
    BooksTab.name: (routeData) {
      ...
      return _i4.MaterialPageX<dynamic>(
          routeData: routeData, child: _i4.EmptyRouterScreen(key: args.key));
    },
    ProfileTab.name: (routeData) {
      final args = routeData.argsAs<ProfileTabArgs>(
          orElse: () => const ProfileTabArgs());
      return _i4.MaterialPageX<dynamic>(
          routeData: routeData, child: _i4.EmptyRouterPage(key: args.key));
    },
          ...
          _i4.RouteConfig(BooksTab.name,
              ...
              children: [
                ...
                _i4.RouteConfig(BookDetailsRoute.name,
                    ...
                    children: [
                      _i4.RouteConfig(InheritedParamRoute.name,
...
class HomeRoute extends _i4.PageRouteInfo<HomeRouteArgs> {
  HomeRoute({_i13.Key? key, List<_i4.PageRouteInfo>? children})
...
class BooksTab extends _i4.PageRouteInfo<BooksTabArgs> {
  BooksTab({_i13.Key? key, List<_i4.PageRouteInfo>? children})
      : super(BooksTab.name,
            path: 'books',
...
/// generated route for
/// [_i4.EmptyRouterPage]
class ProfileTab extends _i4.PageRouteInfo<ProfileTabArgs> {
  ProfileTab({_i13.Key? key, List<_i4.PageRouteInfo>? children})
...
class BookDetailsRoute extends _i4.PageRouteInfo<BookDetailsRouteArgs> {
  BookDetailsRoute({int id = -1, List<_i4.PageRouteInfo>? children})
...
class InheritedParamRoute extends _i4.PageRouteInfo<InheritedParamRouteArgs> {
  InheritedParamRoute({_i13.Key? key, String nonPathParam = 'defa'})
